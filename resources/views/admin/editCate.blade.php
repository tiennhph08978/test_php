...
<div class="card m-3">
    <div class="card-body">
        ...
        @endif
        <form action="{{route('postEditCate',$cate->id)}}" method="POST">
            @csrf
            <div class="form-group">
              <label for="inputName">Tên danh mục <span class="ml-1 text-danger">*</span></label>
              <input type="text" class="form-control" id="inputName" name="name" value="{{$cate->name}}" placeholder="Tên danh mục">
            </div>
            <div class="form-group">
