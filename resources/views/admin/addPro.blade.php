    ...
    <div class="card-body">
        ...
        <form action="{{route('postAddPro')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="inputName" name="name" placeholder="Tên sản phẩm">
            </div>
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="inputName" name="price" placeholder="Giá">
              </div>
              <div class="form-group">
                <label for="inputName">Số lượng </label>
                <input type="text" class="form-control" id="inputName" name="amount" placeholder="Số lượng">
              </div>
              <div class="form-group">
                <label for="inputName">Ảnh</label>
                <input type="file" class="form-control" name="image" onchange="changeImg(this)" id="image">
